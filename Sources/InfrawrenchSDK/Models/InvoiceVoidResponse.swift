...
public struct InvoiceVoidResponse: Codable, Hashable, Sendable {
    public struct Replacement: Codable, Hashable, Sendable {
        ...
        public var voidedByUserId: String?
