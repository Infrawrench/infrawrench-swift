...
/// Normalized incident lifecycle state as the provider reports it.
public enum ProviderIncidentState: RawRepresentable, Codable, Hashable, Sendable, ParameterValue {
    case investigating
    case identified
    case monitoring
    case resolved
    ...
    public static let allKnownCases: [ProviderIncidentState] = [
        .investigating,
        .identified,
        .monitoring,
        .resolved,
