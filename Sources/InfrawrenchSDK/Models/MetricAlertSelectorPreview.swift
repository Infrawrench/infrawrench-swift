...
public struct MetricAlertSelectorPreview: Codable, Hashable, Sendable {
    public var matchingResourceCount: Int
    /// Up to 10 matching display names, for a live form preview.
    public var sampleResourceNames: [String]
    ...
    public init(
        ...
        self.sampleResourceNames = sampleResourceNames
    }
}
