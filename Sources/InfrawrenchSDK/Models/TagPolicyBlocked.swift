...
public struct TagPolicyBlocked: Codable, Hashable, Sendable {
    public enum Code: RawRepresentable, Codable, Hashable, Sendable, ParameterValue {
        ...
        public init(rawValue: String) {
            switch rawValue {
            case "tag_policy_unmet": self = .tagPolicyUnmet
        ...
        public var rawValue: String {
            switch self {
            case .tagPolicyUnmet: return "tag_policy_unmet"
    ...
    public var violations: [TagPolicyViolation]
    public var requiredTags: [RequiredTag]

    public init(
        error: String,
        code: Code,
        violations: [TagPolicyViolation],
